...
class StlParser(Parser):
    ...
    RULE_literal = 20
    ruleNames = ['interval', 'intervalTime', 'unit', 'expression', 'specification_file', 'specification', 'spec', 'modimport', 'assertion', 'declaration', 'annotation', 'annotation_type', 'variableDeclaration', 'constantDeclaration', 'assignment', 'domainType', 'ioType', 'multdivOp', 'addsubOp', 'comparisonOp', 'literal']
    EOF = Token.EOF
    MINUS = 1
    PLUS = 2
    TIMES = 3
